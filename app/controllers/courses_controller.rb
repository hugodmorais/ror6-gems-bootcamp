class CoursesController < ApplicationController
  ...
  before_action :load_references, only: %i[index new create show edit update created_courses destroy approve unapprove analytics]
  ...
  def course_params
    params.require(:course).permit(:title, :description, :short_description, :language, :price, :level, :published, :avatar, tag_ids: [])
  end
end
